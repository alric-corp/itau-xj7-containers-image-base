...
Same trust model already used by scripts/certificates/certificados.sh for the corporate
...
def parse_lockfile(text):
    ...
    same rule scripts/certificates/certificados.sh already enforces for the CA bundle."""
    entries = {}
